#--------------------------------------------------------------------------------------
#
#' Load IUCLID data to toxval from toxval_source
#' @param oht The current IUCLID OHT to load
#' @param toxval.db The database version to use
#' @param source.db The source database
#' @param log If TRUE, send output to a log file
#' @param remove_null_dtxsid If TRUE, delete source records without curated DTXSID value
#--------------------------------------------------------------------------------------
toxval.load.iuclid <- function(oht, toxval.db, source.db, log=FALSE, remove_null_dtxsid=TRUE){
  source = gsub("iuclid", "IUCLID", oht)
  source_table = paste0("source_", oht)
  verbose = log
  #####################################################################
  ...
  # General source/OHT-specific transformations handled in import script
