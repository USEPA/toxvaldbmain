...
Summary of the sources and counts with the QC status values in v9.6.0.
...
iii. Pass percent calculated as (pass + not determined / total records) x 100, where "not determined" is assumed to be a "pass"
