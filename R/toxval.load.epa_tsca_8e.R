#--------------------------------------------------------------------------------------
#' Loading EPA TSCA 8e to toxval from toxval_source
#'
...
#--------------------------------------------------------------------------------------
toxval.load.epa_tsca_8e <- function(toxval.db, source.db, log=FALSE, remove_null_dtxsid=TRUE){
  source = "EPA TSCA 8e"
  ...
  res$source_url = "https://chemview.epa.gov"
  res$details_text = paste(source,"Details")
