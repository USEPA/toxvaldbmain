#--------------------------------------------------------------------------------------
#' Loading CAL OEHHA REL Derivations to toxval from toxval_source
#'
...
#--------------------------------------------------------------------------------------
toxval.load.caloehha_rel_derivations <- function(toxval.db, source.db, log=FALSE, remove_null_dtxsid=TRUE){
  ...
  res$source_url = "https://oehha.ca.gov/"
  res$details_text = paste(source,"Details")
