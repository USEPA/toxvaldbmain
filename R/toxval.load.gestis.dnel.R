#--------------------------------------------------------------------------------------
#
#' Load GESTIS DNEL data from toxval_source to toxval
#' @param toxval.db The database version to use
#' @param source.db The source database
#' @param log If TRUE, send output to a log file
#' @param remove_null_dtxsid If TRUE, delete source records without curated DTXSID value
#--------------------------------------------------------------------------------------
toxval.load.gestis.dnel <- function(toxval.db,source.db, log=FALSE, remove_null_dtxsid=TRUE){
  source = "GESTIS DNEL"
  ...
  res$source_url = "https://www.dguv.de/ifa/gestis/gestis-dnel-liste/index-2.jsp"
  res$subsource_url = "-"
  res$details_text = paste(source,"Details")
