#--------------------------------------------------------------------------------------
#' Loading NIOSH IDLH to toxval from toxval_source
#'
...
#--------------------------------------------------------------------------------------
toxval.load.niosh_idlh <- function(toxval.db, source.db, log=FALSE, remove_null_dtxsid=TRUE){
  source = "NIOSH IDLH"
  ...
  res$source_url = "https://www.cdc.gov/niosh/idlh/"
  res$details_text = paste(source,"Details")
