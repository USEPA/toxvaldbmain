#--------------------------------------------------------------------------------------
#
#' Load Copper Manufacturers data to toxval from toxval_source
#' @param toxval.db The database version to use
#' @param source.db The source database
#' @param log If TRUE, send output to a log file
#' @param remove_null_dtxsid If TRUE, delete source records without curated DTXSID value
#--------------------------------------------------------------------------------------
toxval.load.copper <- function(toxval.db, source.db, log=FALSE, remove_null_dtxsid=TRUE){
  ...
  nlist = names(res)
  nlist = nlist[!is.element(nlist,c("casrn","name","range_relationship_id","toxval_relationship"))]
