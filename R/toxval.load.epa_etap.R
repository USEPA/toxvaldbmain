#--------------------------------------------------------------------------------------
#' Load EPA ETAP source from toxval_source to toxval
#'
...
#--------------------------------------------------------------------------------------
toxval.load.epa_etap <- function(toxval.db, source.db, log=FALSE, remove_null_dtxsid=TRUE){
  source = "EPA ETAP"
  ...
  res$source_url = "https://www.epa.gov/etap/etap-assessments"
  res$details_text = paste(source,"Details")
